...
namespace AZ
{
    namespace RPI
    {
        ...
        //! ModelBuilder is a collection of helper methods for generating or manipulating model assets.
        class ATOM_RPI_REFLECT_API ModelBuilder
        {
        public:
        ...
        template<typename T>
        size_t ModelBuilder::GetAlignedCount(size_t vertexCount, AZ::RHI::Format vertexFormat, uint32_t alignmentInBytes)
        {
        ...
        template<typename T>
        void ModelBuilder::AlignStreamBuffer(
