...
namespace AZ
{
    namespace RPI
    {
        AZ::Data::Asset<AZ::RPI::BufferAsset> ModelBuilder::CreateBufferAsset(
        ...
        void ModelBuilder::CreateUnitCube(ModelAsset* modelAsset)
        {
        ...
        void ModelBuilder::CreateUnitX(ModelAsset* modelAsset)
        {
